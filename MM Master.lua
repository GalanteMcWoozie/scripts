...
function main()
	...
	notify.addNotify("{E57525}[MM Master] {FFFFFF}Çàïóñê ñêðèïòà", "\nÑêðèïò óñïåøíî ïîäãðóæåí\nÒåêóùàÿ âåðñèÿ: {E57525}v." .. script_vers, 2, 2, 5)
...
print("Checking updates for script")
	downloadUrlToFile(update_url, update_path, function(id, status)
		if status == dlstatus.STATUS_ENDDOWNLOADDATA then
			...
			if tonumber(updateIni.info.vers) > script_vers then
				notify.addNotify("{E57525}[MM Master]{FFFFFF} Îáíîâëåíèå", "Íàéäåíî îáíîâëåíèå: {E57525}v." .. tonumber(updateIni.info.vers) .. "\n(Ñåé÷àñ óñòàíîâëåío: {e57525}v." .. script_vers .. "{FFFFFF})", 2, 2, 6)
	...
	while true do
		...
		downloadUrlToFile(script_url, script_path, function(id, status)
			if status == dlstatus.STATUS_ENDDOWNLOADDATA then
				sampAddChatMessage("{E57525}[MM Master]{FFFFFF} Ñêðèïò óñïåøíî îáíîâëåí ñ {E57525}v." .. script_vers .. " {FFFFFF}íà {E57525}v." .. updateIni.info.vers, -1)
				thisScript():reload()
			end
		end)
		break
